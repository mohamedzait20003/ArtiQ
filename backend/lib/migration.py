...
class Migration(ABC):
    ...
    def create_index(
        ...
        **options
        ...
        try:
            ...
            print(
                f"✓ Created {index_type}index on "
                f"{collection}.{field}{ttl_info}"
            )
        except Exception as e:
    ...
    def create_compound_index(
        ...
        **options
        ...
        try:
            ...
            print(
                f"✓ Created compound index on "
                f"{collection}.({field_names})"
            )
        except Exception as e:
    ...
    def drop_index(self, collection: str, index_name: str):
        ...
        try:
            ...
            print(
                f"✗ Error dropping index {index_name} "
                f"from {collection}: {e}"
            )
    ...
    def insert_document(self, collection: str, document: Dict[str, Any]):
        ...
        try:
            ...
            print(
                f"✗ Error inserting document into {collection}: {e}"
            )
...
class MigrationRunner:
    ...
    def has_run(self, migration_name: str) -> bool:
        ...
        """
        doc = self.db[self.migrations_collection].find_one(
            {'name': migration_name}
        )
    ...
    def mark_as_reverted(self, migration_name: str):
        ...
        Args:
            migration_name: Name of the migration
        """
        self.db[self.migrations_collection].delete_one(
            {'name': migration_name}
        )
