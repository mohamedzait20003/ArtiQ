...
class PerformanceEvaluator:
    ...
    def _prepare_llm_prompt(self, text: str) -> str:
        ...
        return (
            ...
            "Give credit for BOTH claimed performance AND proven performance. "
            "Claims without evidence still deserve points.\n\n"
            ...
            "}\n\n"
            "Scoring guidance:\n"
            "- 0.00–0.20: No performance information at all.\n"
            "- 0.21–0.40: CLAIMS performance (mentions task/dataset/purpose) "
            "but no metrics.\n"
            "- 0.41–0.60: MENTIONS metrics/numbers but minimal context.\n"
            "- 0.61–0.80: SHOWS clear metrics with proper context "
            "(dataset/task described).\n"
            "- 0.81–0.95: PROVES performance with tables/detailed results.\n"
            "- 0.96–1.00: COMPREHENSIVE evidence with comparisons to "
            "baselines/SoTA.\n\n"
            "Be lenient. Give credit for effort even without proof.\n\n"
